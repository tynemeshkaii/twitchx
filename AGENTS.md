...
- Вся коммуникация с пользователем ведётся только на русском языке.
- Статус-апдейты, планы, ревью, уточняющие вопросы и финальные ответы пишутся только на русском, если пользователь явно не попросил другой язык.
- Технические идентификаторы, код, shell-команды, имена API-полей и названия внешних продуктов сохраняются в оригинальном виде.
- Тон общения: краткий, прямой, инженерный. Без маркетинговых формулировок и лишнего текста.
